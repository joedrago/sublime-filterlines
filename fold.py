...
class PromptFoldToLinesInvertedCommand(PromptFilterToLinesCommand):

    def run(self, search_type = 'string'):
        self._run(search_type, "fold_to_lines_inverted", "Fold")


class FoldToLinesInvertedCommand(FilterToLinesCommand):
